...
app.get("/getstartPOS", function (req, res) {
  readFile("data/pitch.json").then(function (pitchSize) {
    readFile("data/teams/Slugs.json").then(function (team1) {
      readFile("data/teams/Dragons.json").then(function (team2) {
        footballEngine
